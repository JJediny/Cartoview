...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'App.licence'
        db.delete_column(u'core_app', 'licence')

        # Adding field 'App.license'
        db.add_column(u'core_app', 'license',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'App.licence'
        db.add_column(u'core_app', 'licence',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'App.license'
        db.delete_column(u'core_app', 'license')
