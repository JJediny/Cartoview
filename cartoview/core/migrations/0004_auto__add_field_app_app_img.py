...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.app_img'
        db.add_column(u'core_app', 'app_img',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'App.app_img'
        db.delete_column(u'core_app', 'app_img')
    ...
    models = {
        ...
        u'core.app': {
            ...
            'app_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
