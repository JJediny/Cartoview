...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.rating_votes'
        db.add_column(u'core_app', 'rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'App.rating_score'
        db.add_column(u'core_app', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'App.rating_votes'
        db.delete_column(u'core_app', 'rating_votes')

        # Deleting field 'App.rating_score'
        db.delete_column(u'core_app', 'rating_score')
