...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_app', 'short_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'App.owner_url'
        db.add_column(u'core_app', 'owner_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'App.help_url'
        db.add_column(u'core_app', 'help_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'App.app_logo'
        db.add_column(u'core_app', 'app_logo',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'App.is_suspended'
        db.add_column(u'core_app', 'is_suspended',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


        # Changing field 'App.app_img'
        db.alter_column(u'core_app', 'app_img', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'App.short_description'
        db.delete_column(u'core_app', 'short_description')

        # Deleting field 'App.owner_url'
        db.delete_column(u'core_app', 'owner_url')

        # Deleting field 'App.help_url'
        db.delete_column(u'core_app', 'help_url')

        # Deleting field 'App.app_logo'
        db.delete_column(u'core_app', 'app_logo')

        # Deleting field 'App.is_suspended'
        db.delete_column(u'core_app', 'is_suspended')


        # Changing field 'App.app_img'
        db.alter_column(u'core_app', 'app_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
