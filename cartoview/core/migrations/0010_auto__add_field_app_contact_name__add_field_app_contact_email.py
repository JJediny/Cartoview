...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.contact_name'
        db.add_column(u'core_app', 'contact_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'App.contact_email'
        db.add_column(u'core_app', 'contact_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'App.contact_name'
        db.delete_column(u'core_app', 'contact_name')

        # Deleting field 'App.contact_email'
        db.delete_column(u'core_app', 'contact_email')
