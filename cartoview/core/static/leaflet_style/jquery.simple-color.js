 ...
 */
  $.fn.simpleColor = function(options) {
    ...
    var defaultColors = ['1abc9c', '2ecc71', '3498db', '9b59b6', '000000', '16a085', '27ae60', '2980b9', '8e44ad', '2c3e50', 'f1c40f', 'e67e22', 'e74c3c', 'ecf0f1', '95a5a6', 'f39c12', 'd35400', 'c0392b', 'bdc3c7', '7f8c8d'
    ...
    options = $.extend({
      ...
      cellWidth:        this.attr('cellWidth') || 16,
      cellHeight:       this.attr('cellHeight') || 16,
    ...
    // Hide the input
    this.hide().val(options.defaultColor);
    ...
    function buildChooser(index) {
      ...
      var displayBox = $("<div class='simpleColorDisplay form-control' />");
