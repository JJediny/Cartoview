...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceType.image'
        db.alter_column(u'catalog_servicetype', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))
        # Adding field 'Settings.show_tags_panel'
        db.add_column(u'catalog_settings', 'show_tags_panel',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Settings.show_categories_panel'
        db.add_column(u'catalog_settings', 'show_categories_panel',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'UrlImage.image'
        db.alter_column(u'catalog_urlimage', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ServiceType.image'
        db.alter_column(u'catalog_servicetype', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
        # Deleting field 'Settings.show_tags_panel'
        db.delete_column(u'catalog_settings', 'show_tags_panel')

        # Deleting field 'Settings.show_categories_panel'
        db.delete_column(u'catalog_settings', 'show_categories_panel')


        # Changing field 'UrlImage.image'
        db.alter_column(u'catalog_urlimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'catalog.settings': {
            ...
            'show_categories_panel': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'show_tags_panel': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'core.app': {
            ...
            'app_img': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'app_logo': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
