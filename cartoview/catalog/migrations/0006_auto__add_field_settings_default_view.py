...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settings.default_view'
        db.add_column(u'catalog_settings', 'default_view',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Settings.default_view'
        db.delete_column(u'catalog_settings', 'default_view')
    ...
    models = {
        ...
        u'catalog.settings': {
            ...
            'default_view': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
